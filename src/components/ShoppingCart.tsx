...
export default function ShoppingCart({
  ...
  return (
    <>
      <div className="shopping-cart fixed inset-0 z-[20] m-auto mt-[4.5rem] flex h-[35vh] w-[95vw] max-w-[450px] flex-col rounded-lg border-none bg-white shadow-lg shadow-dark-gray-blue md:absolute md:left-[50%] md:top-full md:mt-6 md:h-[32vh] md:w-[45vw] md:-translate-x-[65%] md:transform md:p-5 lg:left-[50%] lg:w-[25vw] lg:-translate-x-[50%]">
